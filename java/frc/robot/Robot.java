...
public class Robot extends TimedRobot {
  ...
  public void teleopPeriodic() {
    ...
    if (second_controller.getRawAxis(1) == -1) {
      r4.set(ControlMode.PercentOutput, 0.6);
    } else if (second_controller.getRawAxis(1) == 0) {
    ...
    var motion = second_controller.getRawAxis(2);
    if (motion > 0) {
      l4.set(ControlMode.PercentOutput, motion);
    }
    ...
    var motion2 = second_controller.getRawAxis(3);
    if (motion2 > 0) {
      l4.set(ControlMode.PercentOutput, motion2);
    }
